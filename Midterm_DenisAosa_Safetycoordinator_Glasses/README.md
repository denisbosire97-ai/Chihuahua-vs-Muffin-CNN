...
## Dataset Plan
- **Source**: Public Kaggle/Roboflow datasets ("Warehouse Safety" and "Residential Delivery Hazards"). [Link: https://universe.roboflow.com/]
- **Size**: Approximately 2,000 samples. 
- **Labels**: Bounding box annotations for `forklift`, `loose_pet`, `broken_stairs`, `low_obstacle` & skeleton nodes for knee/hip joints.
